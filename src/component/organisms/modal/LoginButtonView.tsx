    ...
    return (
        <View style={styles.containerView}>
            <View style={{ ...styles.buttonView, paddingBottom: insets.bottom }}>
                <ModalHeader leftContent={() => {
                    return (
                        <ModalHeaderButton onPress={() => {
                            onPressBack?.(true)
                        }}>
                            <Icon24ArrowLeft />
                        </ModalHeaderButton>
                ...
                <View style={{ marginTop: sizeConverter(16) }}>
                    <CustomButton leftIcon={<Icon24GoogleLogin />} onPress={onPressGoogle} buttonStyle={styles.googleButton} textStyle={styles.googleText} text={'구글로 시작하기'} />
                    <CustomButton leftIcon={<Icon24KakaoLogin />} onPress={onPressKakao} buttonStyle={styles.kakaoButton} textStyle={styles.kakaoText} text={'카카오로 시작하기'} />
                    {
                        Platform.OS === 'ios' &&
                        <CustomButton leftIcon={<Icon24AppleLogin />} onPress={onPressApple} buttonStyle={styles.appleButton} textStyle={styles.appleText} text={'Apple로 시작하기'} />
                    }
                </View>
            </View>
        </View>
