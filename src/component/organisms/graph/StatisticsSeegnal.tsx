  ...
  return (
    <View>
      ...
      <View style={styles.contentView}>
        <StatisticsSeegnalItem text={'씨그날을 보냈어요'} count={0} image={images.img_statistics_seegnal_send} />
        <StatisticsSeegnalItem text={'씨그날을 받았어요'} count={0} image={images.img_statistics_seegnal_receive} />
      </View>
    </View>
  )
}
