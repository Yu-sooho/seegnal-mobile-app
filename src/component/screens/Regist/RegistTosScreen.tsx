  ...
  return (
    <CustomSafeAreaView>
      ...
      >
        ...
        <View style={styles.radioView}>
          <RadioTextButton
            ...
            isActive={
              agreeService && agreePersnal && agreeSensitive && agreeMaketing
            }
            text={'전체 동의'}
            containerStyle={{
          ...
          <RadioTextButton
            ...
            rightContent={() => {
              return (
                <RightArrowButton
                  onPress={() => onPressDetail(AGREELIST['SERVICE'])}
                />
              )
            }}
            containerStyle={{
          ...
          <RadioTextButton
            ...
            rightContent={() => {
              return (
                <RightArrowButton
                  onPress={() => onPressDetail(AGREELIST['PERSNAL'])}
                />
              )
            }}
            containerStyle={{
          ...
          <RadioTextButton
            ...
            rightContent={() => {
              return (
                <RightArrowButton
                  onPress={() => onPressDetail(AGREELIST['SENSTIVE'])}
                />
              )
            }}
            containerStyle={{
      ...
      <FloatingNextButton
        onPress={onPressNext}
        text={'다음'}
        disabled={!agreePersnal || !agreeSensitive || !agreeService}
      />
    </CustomSafeAreaView>
  )
}
