...
import {
  Icon40DefaultGraph,
  Icon40DefaultHistory,
  Icon40DefaultHome,
  Icon40DefaultSetting,
  Icon48ActiveGraph,
  Icon48ActiveHistory,
  Icon48ActiveHome,
  Icon48ActiveSetting,
} from '../component/icons'
import { isHomeAds, selectedTheme } from '../stores'
...
const MainTabNavigator = ({ navigation, route }: Props) => {
  const [theme] = useAtom(selectedTheme)

  const insets = useSafeAreaInsets()
  const [enableAds, setEnableAds] = useAtom(isHomeAds)
  ...
  return (
    ...
    >
      ...
      />
      <Animated.View
        pointerEvents={fadeValue.value > 0 ? 'auto' : 'none'}
